...
Observations:
- If there was no linear association, I would expect the line to be horizontal
- in this case, the weak negative linear association. As miles increases, I would expect price to decrease. The relationship looks weak (the correlation is -0.08)
